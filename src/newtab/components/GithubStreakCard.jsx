  ...
  return (
    ...
    >
      <div className="flex items-center gap-3 text-[#A0A0A0]">
        ...
        <h2 className="font-bold text-lg text-[#F5F5F5]">GitHub Activity</h2>
      </div>
      ...
      {loading ? (
        ...
        <div className="flex flex-col gap-5">
          <div className="flex items-end justify-between w-full">
            <div className="flex items-baseline gap-2">
              <span className="text-5xl font-extrabold text-[#F5F5F5] tracking-tight">{data.streak}</span>
              <span className="text-[#A0A0A0] font-medium">day streak</span>
            </div>
          </div>
        ...
        <div className="text-[#A0A0A0] text-sm font-medium">Failed to load GitHub activity.</div>
      )}
    </motion.div>
  );
}
